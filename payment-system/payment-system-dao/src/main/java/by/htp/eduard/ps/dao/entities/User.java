...
public class User implements Serializable {
	...
	public String toString() {
		return "User [id=" + id + ", login=" + login + ", password=" + password + ", name=" + name + ", surname="
				+ surname + ", address=" + address + ", roleId=" + roleId + ", passportSeries=" + passportSeries
				+ ", passportId=" + passportId + ", codeWord=" + codeWord + ", phoneNumber=" + phoneNumber
				+ ", residenceRegistr=" + residenceRegistr + "]";
	}
}
