            ...
            <section class="content">
                ...
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">List payment systems</h3>
                    ...
                    <div class="card-body">
                        <div id="example2_wrapper" class="dataTables_wrapper dt-bootstrap4">
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <a href="add-payment-system" class="btn btn-success">Add new payment system</a> <br> <br>
                                        ...
                                        <tbody>
                                            ...
                                            <c:forEach var="paymentSystem" items="${allPaymentSystems}">
                                                <tr role="row" class="odd">
                                                    <td class="sorting_1">${paymentSystem.id}</td>
                                                    <td>${paymentSystem.name}</td>
                                                    <td>
                                                        <c:url value="edit-payment-system" var="editUrl">
                                                            <c:param name="systemId" value="${paymentSystem.id}" />
                                                        </c:url>
                                                        
                                                        <c:url value="delete-payment-system" var="deleteUrl">
                                                            <c:param name="systemId" value="${paymentSystem.id}" />
                                                        </c:url>
