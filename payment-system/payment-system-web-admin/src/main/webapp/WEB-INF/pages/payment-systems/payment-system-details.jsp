...
<title>Payment systems card</title>
            ...
            <section class="content">
                ...
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Save payment system</h3>
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="tab-pane" id="settings">
                                        <form action="save-payment-system" method="post" class="form-horizontal">
                                            <input type="hidden" name="id" value="${paymentSystem.id}">
                                            <div class="form-group row">
                                                <label for="inputName" class="col-sm-2 col-form-label">Name</label>
                                                <div class="col-sm-10">
                                                    <input type="text" name="newNamePaySyst" value="${paymentSystem.name}" class="form-control" id="inputName" placeholder="Name">
                                                    <mvc:error code="name.paymentSystem.empty">
                                            ...
                                            <div class="form-group row">
                                                <div class="offset-sm-2 col-sm-10">
                                                    <a href="payment-system-list" type="submit" class="btn btn-default">Cancel</a>
