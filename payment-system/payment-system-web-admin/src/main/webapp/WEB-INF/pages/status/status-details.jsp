            ...
            <section class="content">
                ...
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Save status</h3>
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="tab-pane" id="settings">
                                        <form action="save-status" method="post" class="form-horizontal">
                                            <input type="hidden" name="id" value="${status.id}">
                                            <div class="form-group row">
                                                <label for="inputName" class="col-sm-2 col-form-label">Name</label>
                                                <div class="col-sm-10">
                                                    <input type="text" name="nameStatus" value="${status.name}" class="form-control" id="inputName" placeholder="Name">
                                                    <mvc:error code="name.status.empty">
                                            ...
                                            <div class="form-group row">
                                                <div class="offset-sm-2 col-sm-10">
                                                    <a href="status-list" type="submit" class="btn btn-default">Cancel</a>
